...
train_dataset = UPFD('politifact', args.dataset, args.feature, 'train', ToUndirected())
val_dataset = UPFD('politifact', args.dataset, args.feature, 'val', ToUndirected())
test_dataset = UPFD('politifact', args.dataset, args.feature, 'test', ToUndirected())
